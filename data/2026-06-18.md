...
### [3] [On (Non-)Isomorphism of Self-Dual Lattices and Codes](https://arxiv.org/abs/2606.18662)
...
### [4] [Fair Online Resource Allocation](https://arxiv.org/abs/2606.18679)
...
### [5] [Compact multi-text index for circular Cartesian tree matching](https://arxiv.org/abs/2606.18696)
...
### [6] [Learning Augmented Exact Exponential Algorithms](https://arxiv.org/abs/2606.18807)
...
### [7] [Tractable Gap-Constraint Languages for Complex Event Recognition](https://arxiv.org/abs/2606.18878)
...
### [8] [Guarded Epoch Bloom Filters for Sliding-Window Membership](https://arxiv.org/abs/2606.19210)
...
### [9] [Mixed-Precision Communication-Avoiding SGD for Generalized Linear Models on GPUs](https://arxiv.org/abs/2606.18463)
...
### [10] [Flexible Distributed Particle Filtering for the Internet of Things via Aggregate Computing](https://arxiv.org/abs/2606.18483)
...
### [11] [Splaxel: Efficient Distributed Training of 3D Gaussian Splatting for Large-scale Scene Reconstruction via Pixel-level Communication](https://arxiv.org/abs/2606.18588)
...
### [12] [ShuntServe: Cost-Efficient LLM Serving on Heterogeneous Spot GPU Clusters](https://arxiv.org/abs/2606.18600)
...
### [13] [HI-HCQC: A Tightly-Coupled Hardware Interface with High-Efficiency Communication for Hybrid Classical-Quantum Computing](https://arxiv.org/abs/2606.18642)
...
### [14] [Re-Rooting-Based Fault-Tolerant One-to-All Broadcasting in Dense Eisenstein--Jacobi Networks](https://arxiv.org/abs/2606.18712)
*Bader Albader*
...
### [15] [Closed-Form and Constant-Time New-Source Selection for Fault-Tolerant Broadcasting in Dense Eisenstein--Jacobi Networks](https://arxiv.org/abs/2606.18714)
*Bader Albader*
...
### [16] [Closed-Form and Constant-Time New-Source Selection for Fault-Tolerant Broadcasting in Dense Gaussian Networks](https://arxiv.org/abs/2606.18715)
*Bader Albader*
...
### [17] [ReMP: Low-Downtime Runtime Model-Parallelism Reconfiguration for LLM Serving](https://arxiv.org/abs/2606.18741)
...
### [18] [Compressed-Resident Genomics: Full-Pipeline Device-Resident GPU LZ77 Decode with Position-Invariant Random Access](https://arxiv.org/abs/2606.18900)
*Yakiv Shavidze*
...
### [19] [Urban Limits as Design Constraints: Identifying Suitable Locations for Distributed, Photovoltaic-Powered Servers](https://arxiv.org/abs/2606.18940)
...
### [20] [LiveStack: OS Support for Cluster-Scale Full-Stack Live Simulation](https://arxiv.org/abs/2606.18958)
...
### [21] [A Composable CRDT Layer for Byzantine-Resilient Deterministic Reconstruction](https://arxiv.org/abs/2606.18966)
*Amos Brocco*
...
### [22] [On the Notions of Bounded Bypass, and How to Make any Deadlock-Free MUTEX Protocol Satisfy One of Them](https://arxiv.org/abs/2606.19003)
...
### [23] [Spotlight: Synergizing Seed Exploration and Spot GPUs for DiT RL Post-Training](https://arxiv.org/abs/2606.19004)
...
### [24] [Pulse: Training Acceleration for Large Diffusion Models with Automatic Pipeline Parallelism](https://arxiv.org/abs/2606.19163)
...
### [25] [TurboServe: Serving Streaming Video Generation Efficiently and Economically](https://arxiv.org/abs/2606.19271)
