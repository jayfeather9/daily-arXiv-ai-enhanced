...
### [5] [DT-RAID: A Software-Defined Tiered RAID Architecture for Heterogeneous SSDs](https://arxiv.org/abs/2609.16003)
...
### [6] [Is INT8 Portable? A Cross-Platform Measurement Study of Quantized Inference on Embedded and Automotive Accelerators](https://arxiv.org/abs/2609.16085)
*Yuyeong Shin*
...
### [7] [The World Model Hardware Accelerator](https://arxiv.org/abs/2609.16244)
*Shashank Chaurasia*
...
### [8] [EBL: Efficient Broad Learning for Distributed Adaptive Harmonic Analysis](https://arxiv.org/abs/2609.16358)
...
### [9] [FSNIC: A Low-Latency Flow-Based Intrusion Detection Architecture for FPGA SmartNICs](https://arxiv.org/abs/2609.16363)
...
### [10] [FINNAS: FINN-Guided Hardware-Aware NAS and Pruning for FPGA Jet Substructure Classification](https://arxiv.org/abs/2609.16367)
...
### [11] [ScaleLUT: A Fully-Parallel Configurable LUT-Based Accelerator for Real-Time Multi-Scale Super-Resolution](https://arxiv.org/abs/2609.16508)
...
### [12] [A 420 GOPS/W CGRA with a Configurable MAC and Dynamic Truncation](https://arxiv.org/abs/2609.16600)
...
### [13] [SpecLens: LLM-Based Verilog Generation with Specification-Derived Constraints via Behavioral Divergence](https://arxiv.org/abs/2609.16729)
*Wen Bing,Bing Li*
...
### [14] [Carry-Through Checksum: A Lightweight Fault-Detection for CNN Inference at the Edge](https://arxiv.org/abs/2609.16742)
...
### [15] [OptiPrime: Optimizing Private Inference through Protocol-Hardware Co-design](https://arxiv.org/abs/2609.16898)
...
### [16] [Budgeted Express-Mesh: Traffic-Aware Link Placement and Deadlock-Free Adaptive Routing](https://arxiv.org/abs/2609.17057)
*Li Cao,Jingyuan Ma*
...
### [17] [Novel Iterative Construction Methods for the Blocking Job Shop Scheduling Problem](https://arxiv.org/abs/2609.16007)
...
### [18] [Co-Skill: A Collaborative Communication Framework for Skill Evolution](https://arxiv.org/abs/2609.16008)
...
### [19] [Vectorization Of Narrow Matrix Multiplication for Ascend AI Inference Acceleration](https://arxiv.org/abs/2609.16009)
...
### [20] [BOA: Beamwidth Online Adaptation for Filtered-ANNS on a GPU](https://arxiv.org/abs/2609.16175)
...
### [21] [Cognitive Admission Control: Risk-Conditioned Assurance for Consequential Actions in Agentic Distributed Systems](https://arxiv.org/abs/2609.16313)
*Jun He,Deying Yu*
...
### [22] [PipeSwift: Revisiting Pipeline Parallelism for Large-Scale Completion-Oriented Agentic Serving](https://arxiv.org/abs/2609.16491)
...
### [23] [XMPIaaS: Towards Cloud Native MPI via Cooperative Process Migration](https://arxiv.org/abs/2609.16531)
...
### [24] [DeepShare: Assurance-Driven Deep Learning Job Scheduling for Multi-Tenant Clusters](https://arxiv.org/abs/2609.16682)
...
### [25] [The Price of Random Access: Measuring Block Granularity Across Four Compressed Formats](https://arxiv.org/abs/2609.16731)
*Yakiv Shavidze*
...
### [26] [Nested Parallel von Neumann Architecture and Nested BSP](https://arxiv.org/abs/2609.16787)
*Heng Liao*
...
### [27] [Byzantine Reliable Broadcast with Causal Ordering](https://arxiv.org/abs/2609.17074)
...
### [28] [DS2-Based Cross-Data-Space Interoperability for Precision Agriculture](https://arxiv.org/abs/2609.17185)
...
### [29] [Scheduling Jobs with Multiple Operational Modes and Tail Times](https://arxiv.org/abs/2609.16001)
...
### [30] [SETH-based Lower Bound for Dynamic Degeneracy](https://arxiv.org/abs/2609.16303)
...
### [31] [A deterministic $(2 + \varepsilon)$-approximation for directed feedback vertex sets in tournaments](https://arxiv.org/abs/2609.16723)
...
### [32] [Improved Approximation for Unsplittable CVRP via a Greedy Approach](https://arxiv.org/abs/2609.16910)
...
### [33] [Improved Regular Expression Matching with Simple Backreferences](https://arxiv.org/abs/2609.16914)
...
### [34] [High-Multiplicity Bin Packing is FPT](https://arxiv.org/abs/2609.16923)
...
### [35] [Rank-One Matrix Discrepancy and Algorithmic Kadison--Singer](https://arxiv.org/abs/2609.17266)
...
### [36] [High Probability Streaming Lower Bounds for $F_2$ Estimation](https://arxiv.org/abs/2609.17286)
...
### [37] [Online Allocation using Few Samples](https://arxiv.org/abs/2609.17343)
...
### [38] [The Classical Weisfeiler-Leman Algorithm Stabilizes in $O(n)$ Rounds](https://arxiv.org/abs/2609.17364)
...
### [39] [PrecPack: An Efficient Open-Source Exact Solver for Bin Packing with Generalized Precedence Constraints](https://arxiv.org/abs/2609.17368)
...
### [40] [Pseudometric-Weighted Correlation Clustering via Spectral Preclustering](https://arxiv.org/abs/2609.17403)
...
### [41] [Determinant maximization subject to a partition matroid constraint via stable distributions](https://arxiv.org/abs/2609.17407)
...
### [42] [Stuffed IBLTs: Optimal Linear Multiset Sketches](https://arxiv.org/abs/2609.17487)
