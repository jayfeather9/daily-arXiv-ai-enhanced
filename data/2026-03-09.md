...
### [1] [How to Sort in a Refrigerator: Simple Entropy-Sensitive Strictly In-Place Sorting Algorithms](https://arxiv.org/abs/2603.05676)
...
### [2] [Forwarding Packets Greedily](https://arxiv.org/abs/2603.06039)
...
### [3] [Transversal Rank, Conformality and Enumeration](https://arxiv.org/abs/2603.06402)
*Martin Schirneck*
...
### [5] [Parallelization Strategies for Dense LLM Deployment: Navigating Through Application-Specific Tradeoffs and Bottlenecks](https://arxiv.org/abs/2603.05692)
...
### [6] [A Lock-Free Work-Stealing Algorithm for Bulk Operations](https://arxiv.org/abs/2603.05766)
...
### [7] [Gathering Autonomous Mobile Robots Under the Adversarial Defected View Model](https://arxiv.org/abs/2603.05788)
...
### [8] [StreamWise: Serving Multi-Modal Generation in Real-Time at Scale](https://arxiv.org/abs/2603.05800)
...
### [9] [Knowledge-driven Reasoning for Mobile Agentic AI: Concepts, Approaches, and Directions](https://arxiv.org/abs/2603.05831)
...
### [10] [Domain-Adaptive Model Merging across Disconnected Modes](https://arxiv.org/abs/2603.05957)
...
### [11] [Edge Intelligence-Driven LegalEdge Contracts for EV Charging Stations: A Fedrated Learning with Deep Q-Networks Approach](https://arxiv.org/abs/2603.06041)
...
### [12] [Provuse: Platform-Side Function Fusion for Performance and Efficiency in FaaS Environments](https://arxiv.org/abs/2603.06170)
...
### [13] [MoEless: Efficient MoE LLM Serving via Serverless Computing](https://arxiv.org/abs/2603.06350)
...
### [14] [Comparative Analysis of Cross-Chain Token Standards](https://arxiv.org/abs/2603.06388)
...
### [15] [LUMINA: LLM-Guided GPU Architecture Exploration via Bottleneck Analysis](https://arxiv.org/abs/2603.05904)
...
### [16] [A Persistent-State Dataflow Accelerator for Memory-Bound Linear Attention Decode on FPGA](https://arxiv.org/abs/2603.05931)
...
### [17] [Hybrid Structured Editing: Structures for Tools, Text for Users](https://arxiv.org/abs/2603.05644)
...
### [18] [Pitfalls in VM Implementation on CHERI: Lessons from Porting CRuby](https://arxiv.org/abs/2603.05645)
...
### [19] [Evaluating LLMs in the Context of a Functional Programming Course: A Comprehensive Study](https://arxiv.org/abs/2603.05646)
...
### [20] [JoinActors: A Modular Library for Actors with Join Patterns](https://arxiv.org/abs/2603.05648)
...
### [21] [Efficient Selection of Type Annotations for Performance Improvement in Gradual Typing](https://arxiv.org/abs/2603.05649)
