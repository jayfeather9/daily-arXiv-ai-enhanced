...
### [3] [The Illusion of Independent Quorums: Epistemic Fault Domains and Correlated Cognitive Failures in Agentic Quorums](https://arxiv.org/abs/2609.02925)
*Jun He,Deying Yu*
...
### [4] [FlowTT: Exploiting Computation Flow Reuse in Irregular Tensor-Train Embedding](https://arxiv.org/abs/2609.03459)
...
### [5] [Fully Fluctuating Sleepy Consensus from Minimal Assumptions](https://arxiv.org/abs/2609.03063)
...
### [6] [Skywing: A Platform for Decentralized Mathematical Computing in Unreliable Environments](https://arxiv.org/abs/2609.03145)
...
### [8] [Carbon-aware Resource Management for Latency-Sensitive Cloud Computing Environments: A Taxonomy and Future Directions](https://arxiv.org/abs/2609.03270)
...
### [9] [A Technique for Load Shifting Low-latency Applications in Multi-Region Renewables Harvesting via SMT Core Pooling](https://arxiv.org/abs/2609.03297)
...
### [10] [Lantern: Finding Committable Transactions via Back-Propagation on DAGs](https://arxiv.org/abs/2609.03315)
...
### [11] [Iapetus: Content-Aware Hierarchical Scheduling for Collaborative ViT Inference in LEO Satellite Networks](https://arxiv.org/abs/2609.03318)
...
### [12] [Latency-Aware Orchestration for Multi-Agent LLM Workflows on Heterogeneous GPUs](https://arxiv.org/abs/2609.03335)
...
### [13] [JuPyLive: Seamless Migration of Jupyter Notebook Resources from Laptop to HPC](https://arxiv.org/abs/2609.03562)
...
### [14] [Every Kernel Is a Join: Automatic Multi-GPU Parallelism for AI Computations in Einsummable](https://arxiv.org/abs/2609.03905)
...
### [15] [Barnacle: Adaptive Multi-Leader Scheduling for DAG-Based Consensus](https://arxiv.org/abs/2609.03978)
...
### [17] [Learning Multiband Signals and Fourier-sparse Signals](https://arxiv.org/abs/2609.02977)
...
### [18] [SparseStack Is an Optimal Oblivious Subspace Embedding](https://arxiv.org/abs/2609.02978)
*Diar Heidary*
...
### [19] [Assortment and Procurement Design in Dual-Mode Content Platforms](https://arxiv.org/abs/2609.03285)
...
### [20] [Improved algorithm for counting spanning trees by $\ell_1$-regularized resistance](https://arxiv.org/abs/2609.03574)
...
### [21] [A PTAS for Non-Adaptive Stochastic Top-$k$ Sum under General Combinatorial Constraints](https://arxiv.org/abs/2609.03685)
*Yu Liu*
...
### [22] [The 11/6 supremum of the Wang-Sitters rounding scheme for graph balancing](https://arxiv.org/abs/2609.03890)
*Adam Y. Shavit*
...
### [23] [Batched Pandora's Box](https://arxiv.org/abs/2609.04059)
...
### [24] [Diffuse Gaussian Truncation For Deterministic Approximate Counting](https://arxiv.org/abs/2609.04079)
*Zihong Yi*
...
### [25] [A Time-Encoded Analog Photonic Interposer for Energy-EfficientIntegration of Analog Vision Sensors and Analog Accelerators](https://arxiv.org/abs/2609.03125)
...
### [26] [A single-precision floating-point systolic Givens-QRD Triangular Solver for MVDR Beamforming](https://arxiv.org/abs/2609.03137)
...
### [27] [LevelSyn: Physical-Aware Logic Synthesis via Level-Asynchronous Graph Neural Networks](https://arxiv.org/abs/2609.03594)
...
### [28] [Confidence-Gated Admission for Hardware Prefetching: When the Gate Matters More Than the Predictor](https://arxiv.org/abs/2609.04040)
