...
### [8] [StreamDQ: Near-Memory Weight DeQuantization in Custom HBM for Scalable AI Inference Acceleration](https://arxiv.org/abs/2607.08993)
...
### [9] [Improved Error Bounds for Pure Differentially Private Continual Counting via Matrix Factorization](https://arxiv.org/abs/2607.08963)
...
### [10] [Improved lower bounds of the time complexity of shellsort](https://arxiv.org/abs/2607.08997)
*Zhenghan Zang*
...
### [11] [Rank-Independent Spectral Hypergraph Sparsification via Global-Dictionary Chaining](https://arxiv.org/abs/2607.09074)
...
### [12] [Achieving Almost Exact Recovery in Almost Quadratic Time: Rank-Based Graph Matching via Local Tree Correlation Tests](https://arxiv.org/abs/2607.09087)
...
### [13] [Gårding's Theorem for Posynomials](https://arxiv.org/abs/2607.09168)
*Nima Anari*
...
### [14] [General Non-Clairvoyant KV-Cache Scheduling via Regime-Aware Routing](https://arxiv.org/abs/2607.09248)
...
### [15] [Matroid Contention Resolution with Concentration](https://arxiv.org/abs/2607.09268)
...
### [16] [Faster Exact Algorithms for Equal-Subset-Sum](https://arxiv.org/abs/2607.09289)
...
### [17] [A Polynomial-Time Algorithm for Coloring Perfect Graphs Based on Walk Counting](https://arxiv.org/abs/2607.09309)
...
### [18] [Subexponential Algorithm for High Multiplicity Fair Division of Mixed Instances via Stereometry](https://arxiv.org/abs/2607.09327)
...
### [19] [Spanning Paths and Cycles: Structural Limitations of the Irrelevant Vertex Technique](https://arxiv.org/abs/2607.09342)
...
### [20] [Strong Refutation of Random Ordering CSPs](https://arxiv.org/abs/2607.09410)
*Xifan Yu*
...
### [21] [A combinatorial framework for clustering graph states: Algorithms and hardness for rank-integrity](https://arxiv.org/abs/2607.09469)
...
### [22] [Streaming with Catalytic Memory](https://arxiv.org/abs/2607.09475)
...
### [23] [Terminal Dimension Reduction for Time Series with Applications](https://arxiv.org/abs/2607.09490)
...
### [24] [Improved Approximation of Min-Distances in Near-Linear Time](https://arxiv.org/abs/2607.09588)
*Yael Kirkpatrick*
...
### [25] [System Capybara: Tracking Capabilities for Separation and Freshness (Extended Version)](https://arxiv.org/abs/2607.09383)
...
### [26] [Bidirectional Elaborators à la Carte](https://arxiv.org/abs/2607.09564)
...
### [27] [Quantum Orchestras: a Concrete Semantics for Recursive Hybrid Programs](https://arxiv.org/abs/2607.09605)
...
### [28] [Kleene Algebra with Transitive Commutativity Conditions](https://arxiv.org/abs/2607.09635)
...
### [29] [Network Analysis with Parametric NetKAT](https://arxiv.org/abs/2607.09637)
