...
### [1] [A Note on Diameter Certification in Trees](https://arxiv.org/abs/2607.09929)
*Josef Erik Sedláček*
...
### [2] [Trusted Floors Under Untrusted Learners: A Runtime Assured-SLO Guard for ML Serving](https://arxiv.org/abs/2607.09992)
*Hsiu-Chi Tsai*
...
### [3] [Descriptive Execution of HPC Applications and Workflows](https://arxiv.org/abs/2607.10081)
...
### [4] [Consensus as Collapse Policy: Communication Evidence, Horizons, and Prefix Decisions](https://arxiv.org/abs/2607.10152)
*Tomislav Grospić*
...
### [5] [Automated Tensor Scheduling for Hybrid CPU-GPU LLM Inference on Consumer Devices](https://arxiv.org/abs/2607.10183)
...
### [6] [Byzantine Accountability Without Consensus: Strong Eventual Consistency for Non-Associative, Stochastic, Robust Aggregation](https://arxiv.org/abs/2607.10305)
*Ryan Gillespie*
...
### [7] [Stateful Worlds, Stateless Elasticity: Exact-State Serving for Interactive World Models](https://arxiv.org/abs/2607.10389)
*Jin Li,Jiawei Chen*
...
### [8] [CloudMicroHaskell: Direct-Style Distributed Haskell via Runtime Graph Serialisation](https://arxiv.org/abs/2607.10443)
...
### [9] [Ichnos+: Estimating the Carbon Footprint of Scientific Workflows Using Fitted Power Models](https://arxiv.org/abs/2607.10586)
...
### [10] [[AAFLOW+] Stateful Operator Abstraction with Zero-Copy Distributed KV Cache Orchestration for Multi-Agent Workflows](https://arxiv.org/abs/2607.10987)
...
### [11] [Domain Extension of Lock-Freedom and Wait-Freedom for Group Computations](https://arxiv.org/abs/2607.11014)
...
### [12] [Energy Calculus: A Compositional Algebra of Energy in Computational Systems](https://arxiv.org/abs/2607.11087)
...
### [13] [Xema: Efficient Diffusion Serving through Fine-Grained Memory Management and Auto-Configuration](https://arxiv.org/abs/2607.11136)
...
### [14] [GPU-Tile-Sim: A Tile-Centric GPU Simulation Framework for LLM Hardware-Software Co-Design](https://arxiv.org/abs/2607.11262)
...
### [15] [Decomposing Runtime, Kernel, and Quantization Speedups via a Matched FP16 Intermediate: A Hardware-Conditioned Case Study on Four NVIDIA RTX A5000 GPUs](https://arxiv.org/abs/2607.11368)
*Weijia Han,Lisha Qu*
...
### [34] [Courcelle's Theorem in Truly Linear FPT](https://arxiv.org/abs/2607.11230)
...
### [35] [Bounded-Support Additive Latin Transversals via Color-Counted Matching](https://arxiv.org/abs/2607.11241)
...
### [36] [Approximation Algorithms for Discounted Graph Search with Norm Objectives](https://arxiv.org/abs/2607.11301)
...
### [37] [Optimal chain density, entropy, and space-time tradeoffs for the TSP](https://arxiv.org/abs/2607.11311)
...
### [38] [Finding Nearly-Periodic Components in Digraphs and Markov Chains from the Spectrum of Rotated Laplacian Matrices](https://arxiv.org/abs/2607.11333)
...
### [39] [Low latency data-flow graphs for simultaneous modular inversion of many inputs](https://arxiv.org/abs/2607.11337)
*Tamas Visegrady*
...
### [40] [Minimum Degree Spanning Tree: $(1+ε,1)$-Approximation in Near-Linear Time](https://arxiv.org/abs/2607.11413)
...
### [41] [Philosopher and Prophet Inequalities for Divisible Items](https://arxiv.org/abs/2607.11742)
...
### [43] [Programming with Ellipses](https://arxiv.org/abs/2607.10001)
...
### [44] [Mechanised operational semantics of Rowhammer](https://arxiv.org/abs/2607.10314)
...
### [45] [K-ESBMC: An Executable Formal Semantics of IEC 61131-3 Ladder Diagram for Validating Verifier Translations](https://arxiv.org/abs/2607.10499)
...
### [46] [Fuss-free cumulative universes: theory and practice](https://arxiv.org/abs/2607.11329)
...
### [47] [A Separation Logic for Parallel Time Complexity with Work and Span Credits](https://arxiv.org/abs/2607.11582)
...
### [48] [Mizzle: A Complete Concurrent Incorrectness Logic for Preventing False Alarms in Agentic Bug Finding](https://arxiv.org/abs/2607.11611)
*Alexandre Moine,Sam Westrick,Joseph Tassarotti*
...
### [49] [On Thread Convergence](https://arxiv.org/abs/2607.11636)
...
### [50] [The Time-Space Complexity of Checking Multiple Assertions in Quantum Programs](https://arxiv.org/abs/2607.11665)
...
### [51] [Complexity Theory of Randomised Testing](https://arxiv.org/abs/2607.11811)
...
### [52] [Chiplet3D: Pin- and Thermal-Aware 3D Chiplet Floorplanning via Convolution-Embedded MILP](https://arxiv.org/abs/2607.09742)
...
### [53] [WINT: A Novel Weighted Integer Representation with Improved Error Characteristics](https://arxiv.org/abs/2607.09775)
...
### [54] [FlashAccel: Leveraging High-Bandwidth Flash for High-Throughput LLM Inference](https://arxiv.org/abs/2607.10186)
...
### [55] [When Fuzzing Meets Understanding: LLM-Driven Semantic Test Generation for RTL Verification](https://arxiv.org/abs/2607.10340)
...
### [56] [Dynamic Rowhammer Threshold Management:Temperature-Aware Threshold Degradation for In-DRAM Defenses](https://arxiv.org/abs/2607.10392)
...
### [57] [Soft-Error Characterization and Hardening Trade-offs in Static PCHB Asynchronous Circuits](https://arxiv.org/abs/2607.10788)
...
### [58] [Edge Physical AI Deployment of Vision Transformers on Heterogeneous Edge GPU Targeting Autonomous Vehicles](https://arxiv.org/abs/2607.10942)
...
### [59] [IRONSmith: A Visual Dataflow Design Environment for AMD Ryzen AI NPUs](https://arxiv.org/abs/2607.10944)
...
### [60] [Reliable Associative Lookup in Content-Addressable Memory](https://arxiv.org/abs/2607.11153)
...
### [61] [From Tool Invocation to Source-Mechanism Exploration: Protected White-Box DSE for Open-Source EDA](https://arxiv.org/abs/2607.11294)
