...
### [7] [RTL-Sequencer: Towards Scalable RTL Timing Prediction with the Sequence-based Paradigm](https://arxiv.org/abs/2607.15830)
...
### [8] [DSTAR: Accelerating Diffusion Transformers via Spatial and Temporal Redundancy Reduction](https://arxiv.org/abs/2607.15846)
...
### [9] [From Patterns to Parsers: Automatic Generation of Efficient Hardware Parsers for FPGAs](https://arxiv.org/abs/2607.16058)
...
### [10] [The Multiple-Choice Matroid Secretary Problem](https://arxiv.org/abs/2607.15407)
...
### [11] [The k-Sum Lateness Problem on a Single Machine](https://arxiv.org/abs/2607.15462)
...
### [12] [A Study of Parallelizable Alternatives to Dynamic Time Warping for Aligning Long Sequences](https://arxiv.org/abs/2607.15478)
...
### [13] [Computing markings for fuzzy minimax nets over the Gödel structure](https://arxiv.org/abs/2607.15494)
*Linh Anh Nguyen*
...
### [14] [Testing Distributions Against Bounded Distinguishers](https://arxiv.org/abs/2607.15645)
...
### [15] [NP-Hardness of Connected Components Reconfiguration under Component Jumping on Caterpillar Graphs](https://arxiv.org/abs/2607.15737)
...
### [16] [Contextual Fraction on Permutation Gain Graphs: Exact Algorithms, Query Lower Bounds, and Dynamic Maintenance](https://arxiv.org/abs/2607.16037)
*Ronald Katende*
...
### [17] [Solving Stackelberg Vertex Cover on trees using split and join](https://arxiv.org/abs/2607.16078)
...
### [18] [A Unified Theory of Sparsification](https://arxiv.org/abs/2607.16126)
...
### [19] [Revisiting Real-Time Interval and Throughput Maximization](https://arxiv.org/abs/2607.16163)
...
### [20] [FSZ: Breaking the Prediction-Throughput Trade-off in GPU Lossy Compression](https://arxiv.org/abs/2607.15413)
*Jiajun Huang*
...
### [21] [Scalable LLM Agent Tool Access in the Cloud](https://arxiv.org/abs/2607.15593)
...
### [22] [JoyNexus: Service-Oriented Multi-Tenant Post-Training for VLA Models](https://arxiv.org/abs/2607.16074)
...
### [23] [Every Microsecond Matters: Achieving Near Speed-of-Light Latency in GPU Collectives](https://arxiv.org/abs/2607.16100)
