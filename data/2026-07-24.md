...
### [1] [Algorithmic Approaches to Sequential Decision-Making and Social Epistemology](https://arxiv.org/abs/2607.20636)
*Kavya Ravichandran*
...
### [2] [Edit-Neighboring Data Streams and Privacy under Continual Observation](https://arxiv.org/abs/2607.20727)
...
### [3] [An Improved Linear Extractable Sketch Data Structure for Flow Count Statistics](https://arxiv.org/abs/2607.20830)
...
### [4] [Shortest Paths with Linear Edge Weights](https://arxiv.org/abs/2607.21055)
...
### [5] [Reachability in Directed Acyclic Graphs with Near-Linear Cut Queries](https://arxiv.org/abs/2607.21390)
...
### [6] [PortLBM: A Portable Lattice Boltzmann Tool Leveraging SYCL on AMD, NVIDIA, and Intel GPUs](https://arxiv.org/abs/2607.20650)
...
### [7] [A Framework for Reputation Aware Uninorm-driven Consensus Algorithms for Blockchain Networks](https://arxiv.org/abs/2607.20700)
...
### [8] [The Consensus Number of Untraceable Cryptocurrencies](https://arxiv.org/abs/2607.20929)
...
### [9] [Multimmit: Extending Blocks for Faster Finality](https://arxiv.org/abs/2607.21021)
...
### [10] [Solving Large Traveling Salesman Problems (TSPs) by a Recursive Clustering Algorithm and a Scalable FPGA-Based Implementation](https://arxiv.org/abs/2607.21182)
...
### [11] [Controlled Periodic Synchronization for Efficient Data-Parallel Training](https://arxiv.org/abs/2607.21224)
...
### [12] [Hardware-Software Co-Design for Float16 On-Device Training on RISC-V Single-Core](https://arxiv.org/abs/2607.21130)
...
### [13] [Chip Floorplanning Combining Convex and Non-convex Optimization](https://arxiv.org/abs/2607.21408)
...
### [14] [Imprecise Probabilistic Programming, Precisely: Credal Sets via Graded Monads, BDDs, and Semiring-Parametric Inference (Functional Pearl)](https://arxiv.org/abs/2607.20801)
...
### [15] [GLP: A Grassroots, Multiagent, Concurrent, Logic Programming Language for AI](https://arxiv.org/abs/2607.21189)
*Ehud Shapiro*
...
### [16] [chrKanren: Constraint Handling Rules in a Relational Language](https://arxiv.org/abs/2607.21204)
...
### [17] [CaVE: A Constraint Storage Approach to Handling Integrity Constraints](https://arxiv.org/abs/2607.21207)
...
### [18] [Top-down = Bottom-up: Sound and Complete Characterisations of Liveness by Multiparty Global Protocols](https://arxiv.org/abs/2607.21489)
