...
### [1] [GRADE-RTL: Evaluating LLM-Generated RTL Beyond Compilation](https://arxiv.org/abs/2609.25335)
...
### [2] [NPLSD: Accelerating Line-Segment Detection on NPU Microcontrollers](https://arxiv.org/abs/2609.25022)
...
### [9] [Cloud, Edge, or Split? Profiling Onboard and Split Vision-Language Model Deployment for Drone AI](https://arxiv.org/abs/2609.25415)
...
### [10] [WeightBridge: An Efficient Weight Transfer Library for Reinforcement Learning](https://arxiv.org/abs/2609.25442)
...
### [11] [Fast Recovery for LLM Serving via Decoupled Device Memory Lifetime in Dynamo](https://arxiv.org/abs/2609.25451)
...
### [12] [Adaptive and Cost-Efficient Joint Scheduling of UAV Routes and Analytics with Transit-Borne Fog](https://arxiv.org/abs/2609.25479)
...
### [13] [Co-Fabric: Breaking Host-Domain Boundaries for Unified xPU Interconnection](https://arxiv.org/abs/2609.25560)
...
### [14] [Hydrozoan: Latency-Adaptive DAG Consensus under Mixed Byzantine and Crash Faults](https://arxiv.org/abs/2609.25918)
...
### [15] [Distributed Near-Equitable Coloring in the LOCAL Model](https://arxiv.org/abs/2609.26190)
...
### [16] [PatchKV: Efficient KV Cache Recovery for Dynamically Edited LLM Contexts](https://arxiv.org/abs/2609.26219)
...
### [17] [DHSched: Stateless Control for Stateful Real-Time Avatar Serving](https://arxiv.org/abs/2609.26363)
...
### [18] [Don't let your Memory defy you: Fragmentation-Aware Serverless Allocation with Elastic Memory Locality](https://arxiv.org/abs/2609.26476)
...
### [19] [A Configurable Heuristic for the MLCS Problem](https://arxiv.org/abs/2609.26602)
...
### [20] [Seeking Cost-Optimal Infrastructure Size for Distributed Filesystems: A Ceph Case Study](https://arxiv.org/abs/2609.26616)
...
### [21] [Beyond Natural Language: An Agent-Native Language for Autonomous Science](https://arxiv.org/abs/2609.25421)
...
### [22] [Modular Composition of Inductive Types Using Lean Meta-programming](https://arxiv.org/abs/2609.25427)
*Ramy Shahin*
...
### [23] [On the Offline Version of the Time-Optimal k-Server Problem](https://arxiv.org/abs/2609.25180)
*Oleg Lomachenko*
...
### [24] [Near-Optimal Online Metric Matching on $Δ$-ary HST](https://arxiv.org/abs/2609.25292)
...
### [25] [An Approximation Algorithm for Non-uniform Non-contiguous Translocation Distance](https://arxiv.org/abs/2609.25420)
...
### [26] [Linear-Query Deterministic Approximation for Non-monotone Submodular Maximization under a Knapsack Constraint](https://arxiv.org/abs/2609.25679)
...
### [27] [Structural Complexity of Matching-Match: Dense and Sparse Graphs](https://arxiv.org/abs/2609.26006)
...
### [28] [An $\widetilde{O}\left(n^3 \right)$-Time Sampler for Zero-Field Ferromagnetic Ising Models](https://arxiv.org/abs/2609.26197)
...
### [29] [Approximate Counting of $k$-Paths in $O^*(2^k)$ Time](https://arxiv.org/abs/2609.26246)
*Tomohiro Koana*
...
### [30] [Online Line Aggregation with Deadlines: Randomized Guarantees and Learning-Augmented Tradeoffs](https://arxiv.org/abs/2609.26259)
*Tianhang Lu*
...
### [31] [A $59/33$ Cut-LP Guarantee for Matching Augmentation](https://arxiv.org/abs/2609.26531)
...
### [32] [Pangenome Optimization via Elastic Degenerate Strings](https://arxiv.org/abs/2609.26542)
...
### [33] [Remote Matching: Exact-Cardinality Approximation and Tight UGC Hardness](https://arxiv.org/abs/2609.26671)
...
### [34] [Polylogarithmic Collective Tree Exploration](https://arxiv.org/abs/2609.26789)
