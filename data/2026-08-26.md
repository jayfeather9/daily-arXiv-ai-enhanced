...
### [14] [Streaming algorithms for computing coresets and $k$-median clustering in the Hamming space](https://arxiv.org/abs/2608.24347)
...
### [15] [Instance-Optimality of Bidirectional Dijkstra on Simple Graphs](https://arxiv.org/abs/2608.24380)
...
### [16] [Designing Caterpillars for Graphs: Approximation and Hardness](https://arxiv.org/abs/2608.24510)
...
### [17] [Online and Incremental Fractional Vertex Cover on Trees](https://arxiv.org/abs/2608.24630)
...
### [18] [Polynomial-time Stable Matching in Network Hypergraphs](https://arxiv.org/abs/2608.24728)
...
### [19] [Dynamic Edge Orientation via Random Walks: From Trees to Outerplanar Graphs and Beyond](https://arxiv.org/abs/2608.24776)
...
### [20] [Lower Bounds for Linear Hashing via Arithmetic Kakeya](https://arxiv.org/abs/2608.24866)
...
### [21] [Transformer Accelerator (TFA): A Macro-Op INT8 Hardware Chip for Transformer Inference and Machine Translation](https://arxiv.org/abs/2608.23582)
*Shashank*
...
### [22] [Squeezing the Cache, Preserving the Truth: Monotonic Equipotential Allocation with Geodesia-KV](https://arxiv.org/abs/2608.23599)
...
### [23] [StateTune: Transforming LLM-Assisted EDA Flow Tuning into a Stateful, Closed-Loop Process](https://arxiv.org/abs/2608.23601)
...
### [24] [PACT: Post-route Agentic Checkpoint Tuning for FPGA Timing Closure](https://arxiv.org/abs/2608.23602)
...
### [25] [Elastic KV Cache for LLM Serving:A Working Reclamation Mechanism, and Why Chunked Prefill Already Closes the Gap](https://arxiv.org/abs/2608.23658)
...
### [26] [Pipeline-Native Transformers: Co-Designing Model Architecture and CPU Inference for Bandwidth-Efficient Autoregressive Decode](https://arxiv.org/abs/2608.23841)
*Tom Poperszky*
...
### [27] [Thermal Tuning Overhead in Wafer-Scale Optical Interconnects for LLM MoE Training: A Cross-Layer Analysis and Ferroelectric-Based Mitigation](https://arxiv.org/abs/2608.24637)
...
### [28] [Maia 200: A Software Defined Dataflow System for Large-scale AI Acceleration](https://arxiv.org/abs/2608.24664)
...
### [29] [Simthesizer: An Agent-Driven Simulation Framework for LLM Serving Systems](https://arxiv.org/abs/2608.24650)
