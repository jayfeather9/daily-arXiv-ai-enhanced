...
### [1] [The Nelson-Nguyen Conjecture via Mean-to-Moments Concentration](https://arxiv.org/abs/2609.22548)
*Tung Mai,Anup Rao*
...
### [2] [When Shall We $k$ Meet Again? Tight Algorithms for Diameter and Radius under the Meet Distance](https://arxiv.org/abs/2609.22569)
...
### [3] [Hardness of Online Directed Steiner Network](https://arxiv.org/abs/2609.22605)
...
### [4] [Union-Find with Constant-Time Deletions Across the Optimal Worst-Case Tradeoff](https://arxiv.org/abs/2609.22892)
*Hanqing Li,Ze Hong*
...
### [5] [Local Representatives and Shortest Completions for Next-to-Shortest Paths in Directed Graphs](https://arxiv.org/abs/2609.22940)
*Shisheng Li*
...
### [6] [Busy Time Minimization with Preemption, Migration, and One Resource Requirement](https://arxiv.org/abs/2609.23197)
...
### [7] [The Inverse Lyndon Array](https://arxiv.org/abs/2609.23401)
...
### [8] [An Arboricity-Sensitive Algorithm for the $K_r-e$-Free Graph Sandwich Problem](https://arxiv.org/abs/2609.23458)
...
### [9] [Single-Pass Estimation of the Clustering Coefficient Distribution in Graph Streams](https://arxiv.org/abs/2609.23489)
...
### [10] [Vector Balancing in Polynomial Time](https://arxiv.org/abs/2609.23540)
...
### [11] [Budget-Independent Influence Maximization in Nearly Linear Time](https://arxiv.org/abs/2609.23604)
*Zhijie Zhang*
...
### [12] [A Polynomial Kernel for Planar Directed Feedback Vertex Set](https://arxiv.org/abs/2609.23669)
...
### [13] [A general counting and sampling Lovász local lemma](https://arxiv.org/abs/2609.23671)
...
### [14] [Smoothed Analysis of Inconsistent A*](https://arxiv.org/abs/2609.23680)
...
### [15] [A Simpler and Faster Min-Cost Flow Solver via Min-Ratio Cycles from Distance Oracles](https://arxiv.org/abs/2609.23852)
...
### [16] [Kadison--Singer partitions and Bilu--Linial graph signings in polynomial time](https://arxiv.org/abs/2609.23855)
...
### [17] [Optimal Analysis of Greedy for Stochastic Online Euclidean Matching](https://arxiv.org/abs/2609.23947)
...
### [18] [On Deterministically Computing Total Variation Distance via Zonotope Compression](https://arxiv.org/abs/2609.24235)
*Yucheng Fu*
...
### [19] [Poisson Exchange Beyond Submodularity: Effective Approximation Algorithms for Offline and Online Subset Selection over Matroids](https://arxiv.org/abs/2609.24569)
...
### [20] [Vertex Cover Interdiction in Bipartite Graphs](https://arxiv.org/abs/2609.24624)
...
### [21] [Improved polynomial-time algorithms for detecting and recovering planted $Θ(\sqrt{n})$-cliques](https://arxiv.org/abs/2609.24780)
...
### [22] [FPT Isomorphism Test for $F$-Free Tournaments](https://arxiv.org/abs/2609.24804)
*Daniel Neuen*
...
### [23] [Parameter-Free Triangle Counting](https://arxiv.org/abs/2609.24829)
...
### [24] [A Proof of the Most Informative Boolean Function Conjecture](https://arxiv.org/abs/2609.24931)
...
### [25] [The Facility Advantage in the One-Round Discrete Voronoi Game on a Line](https://arxiv.org/abs/2609.24936)
*Tamal Maharaj*
...
### [26] [Approximating Prize-Collecting TSP below 1.556](https://arxiv.org/abs/2609.24944)
*Hong Li*
...
### [42] [When Does Learning Beat Heuristics? A Case Study in Kubernetes Scheduler Score Plugins](https://arxiv.org/abs/2609.22142)
...
### [43] [The Tethys Dataset: Seven Years of Hourly Smart Water Metering and a Pipeline for Making It Usable](https://arxiv.org/abs/2609.22358)
...
### [44] [Bridging the Vendor Gap: Enabling AMD GPU Support for Awkward Array via ROCm/HIP for the HL-LHC Era](https://arxiv.org/abs/2609.24628)
...
### [45] [Trust-Aware Output Management for Physical Neural Network in Cloud-Continuum Systems](https://arxiv.org/abs/2609.22443)
...
### [46] [Mask-Aware Execution for Efficient JEPA Training](https://arxiv.org/abs/2609.22674)
...
### [47] [Replacing Large Language Models with Jev Decision Models for Low-Latency Edge Service Orchestration](https://arxiv.org/abs/2609.22753)
...
### [48] [NSP: Accelerating Variable-Length LLM Training via Nested Sequence Parallelism](https://arxiv.org/abs/2609.22755)
...
### [49] [From Idle to Urgent: A Resource-Harvested HPC Workflow for High-Fidelity Seismic Estimation](https://arxiv.org/abs/2609.22814)
...
### [50] [DeepSeek Elastic Compute (DSec): A Sandbox Infrastructure for Effective Agentic Training at Scale](https://arxiv.org/abs/2609.22978)
...
### [51] [Silent Failures at the $2^{32}$ Boundary: A Technical Report on Large-Tensor Matrix Multiplication in PyTorch's Apple MPS Backend](https://arxiv.org/abs/2609.22991)
*Junichiro Niimi*
...
### [52] [Accurate Simulation of Distributed Training Jobs with Network Contention Modeling](https://arxiv.org/abs/2609.23278)
...
### [53] [Accurate Distributed Tracing for Large-Scale AI Infrastructure: Time Synchronization as a Foundation for Reliable Observability](https://arxiv.org/abs/2609.23301)
...
### [54] [Co-occurrence Patterns of LoRA Adapters in Production Diffusion Model Inference Services](https://arxiv.org/abs/2609.23321)
...
### [55] [Economical and efficient big data sharing with i-Cloud](https://arxiv.org/abs/2609.23438)
...
### [56] [Conflicting Pattern Formation by Teams of Anonymous, Fully Disoriented Robots](https://arxiv.org/abs/2609.23454)
...
### [57] [Explicit State and Resource Contracts for Low-Precision Pipeline Parallel Training under Captured Graphs](https://arxiv.org/abs/2609.23536)
...
### [58] [SAGE: Optimal-Stopping Peer Selection for Decentralised Federated Learning](https://arxiv.org/abs/2609.23773)
...
### [59] [Byzantine Causal Reliable Broadcast (BCRB) with Constant-Size Message Metadata](https://arxiv.org/abs/2609.24018)
...
### [60] [MCP-GRANITE Benchmark: GRANularity Interface TEsting for MCP-Based LLM Agents](https://arxiv.org/abs/2609.24161)
...
### [61] [A principled approach for energy-efficient training via phase-aware GPU frequency tuning](https://arxiv.org/abs/2609.24205)
...
### [62] [Toward GPU-Resident Climate Models: A Feasibility Study on Lossy Compression for the Spherical Harmonic Transform's Communication Bottleneck](https://arxiv.org/abs/2609.24294)
...
### [63] [Conduit: An Experience Data Plane for Distributed Reinforcement Learning](https://arxiv.org/abs/2609.24456)
...
### [64] [Analytical Power-Aware Provisioning for Prefill-Decode Disaggregated AI Inference](https://arxiv.org/abs/2609.24639)
...
### [65] [Mitigating Front-Running Attacks through Fair and Resilient Transaction Dissemination](https://arxiv.org/abs/2609.24713)
...
### [66] [Tiga: Compiling Graph Message Passing at Scale](https://arxiv.org/abs/2609.24802)
*Mingyuan Chi*
...
### [67] [Who Pays for the KV Cache? Attributing Shared AI Inference Spend Across Kubernetes and LLM Provider Bills](https://arxiv.org/abs/2609.24991)
*Timothy Urista*
...
### [68] [A Linked List of Cases in Language Design](https://arxiv.org/abs/2609.23009)
*Bo Joel Svensson,Benjamin Vedder*
...
Abstract: LispBM is a Lisp dialect for microcontrollers and embedded systems. This paper is about the changes made to LispBM resulting from it being integrated into the VESC family of firmware and thus gaining a userbase.
...
### [69] [Real-to-Sim Generation: Synthesizing Scenario Programs from Real-World Data via Constraint Solving](https://arxiv.org/abs/2609.23342)
...
### [71] [Djinnlang: Higher-Level Programming by Unambiguous Specification with an LLM in the Compiler](https://arxiv.org/abs/2609.23954)
...
### [72] [Categorical Message Passing Language (CaMPL): Syntax and Semantics](https://arxiv.org/abs/2609.24436)
