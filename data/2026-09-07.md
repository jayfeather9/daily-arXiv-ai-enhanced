...
### [1] [Computing Lewis Weights to High Precision by Fixed-Point Iteration](https://arxiv.org/abs/2609.04338)
*Swati Padmanabhan*
...
### [2] [Multiobjective Hypergraph Min-Cut in Quasi-Polynomial Time](https://arxiv.org/abs/2609.04389)
...
### [3] [An iterative rounding $2$-approximation for Feedback Vertex Set via AI-assisted proof of an extreme point property](https://arxiv.org/abs/2609.04414)
...
### [4] [Statistics of Similarity Graphs in Node-Arrival Streams](https://arxiv.org/abs/2609.04505)
...
### [5] [A Polymatroidal Perspective on Random Contraction](https://arxiv.org/abs/2609.04521)
*Karthekeyan Chandrasekaran,Chandra Chekuri,Weihao Zhu*
...
### [6] [Beyond Distance Ordering: Resource Complexity and Universal Optimality of Exact Labeled Directed Shortest Paths](https://arxiv.org/abs/2609.04825)
*Bin Cai*
...
### [7] [On Maximizing a Weakly Submodular Function over a Matroid Constraint via the Greedy Algorithm](https://arxiv.org/abs/2609.05008)
...
### [8] [Online Matching in Convex Bipartite Graphs](https://arxiv.org/abs/2609.05057)
...
### [9] [Performance Study of Serverless Workloads in Confidential Virtual Machines](https://arxiv.org/abs/2609.04478)
...
### [10] [Atlas: Optimizing Deployment of Compound AI Workflows on Heterogeneous Clusters](https://arxiv.org/abs/2609.04513)
...
### [11] [Revisiting MemGuard Overhead: A Reproduction Report](https://arxiv.org/abs/2609.04547)
...
### [12] [Improving Progressive Compression with Adaptive Interpolation and Coefficient Decomposition](https://arxiv.org/abs/2609.04573)
...
### [13] [CIERA: Cross-Iteration Exponent Reuse for Lossless Allgather in Sharded MoE Training](https://arxiv.org/abs/2609.04609)
...
### [14] [GreenPipe: Power Modeling for Containerized DNN Inference on Kubernetes Edge Nodes](https://arxiv.org/abs/2609.04952)
...
### [15] [Corten - Foundational Verification of Rust Programs](https://arxiv.org/abs/2609.04372)
...
### [16] [JLIR: A Julia-Native MLIR-Inspired Intermediate Representation with Automatic JACC Kernel Extraction](https://arxiv.org/abs/2609.04585)
...
### [17] [CPL: A Compact C-like Systems Language with Explicit Low-Level Control](https://arxiv.org/abs/2609.04904)
...
### [18] [Augur: Predicting View Serializability Violations in Relational Data Store Applications](https://arxiv.org/abs/2609.05288)
...
### [19] [Design Docs Are All You Need: An AI-native Machine-Learning Performance Tool](https://arxiv.org/abs/2609.05364)
...
### [21] [MonoMoE: An Efficient Fused Mega-kernel for Quantized MoE Decoding](https://arxiv.org/abs/2609.04244)
...
### [22] [Hardware-conscious Software Training for Deep Neural Network Inference Accelerator Chips to Recover Accuracy Degradation due to Hardware Variabilities](https://arxiv.org/abs/2609.04259)
...
### [23] [Quality Recovery for Quantized KV Caches via Low-Rank Attention Adaptation](https://arxiv.org/abs/2609.04263)
...
### [24] [Compute-in-Memory Attention: A Time-Domain Analog Softmax Circuit with RC-Tunable Temperature](https://arxiv.org/abs/2609.04266)
...
### [25] [Huawei's $τ$ Chip Was Supposed to Melt?](https://arxiv.org/abs/2609.04287)
*Tingbo He*
...
### [26] [Sustainable Edge Vision via Empirically Calibrated DVFS: Eliminating Thermal Throttling on Passively Cooled Hardware](https://arxiv.org/abs/2609.04705)
...
### [27] [FlexPosit: Tunable Fractional Precision for LLM Inference Accelerators](https://arxiv.org/abs/2609.04724)
...
### [28] [A Piecewise-Linear Approximation-based Energy-Efficient Error-Optimized Unsigned Square Rooter for Accuracy-Critical Applications](https://arxiv.org/abs/2609.04783)
...
### [29] [TreeFI: Value-Aware Statistical Fault Injection for Deep Neural Networks](https://arxiv.org/abs/2609.04912)
...
### [30] [APEX-RBD: Mixed-Precision Exploration Framework for Hardware-Efficient Robot Dynamics Accelerator Design](https://arxiv.org/abs/2609.05161)
...
### [31] [Proton Irradiation Characterization of an Open-Source ML Accelerator on a Zynq UltraScale+ MPSoC](https://arxiv.org/abs/2609.05249)
