...
### [1] [Eulerian-spanning set and coboundary operator: An investigation of maxcut beyond planar graphs](https://arxiv.org/abs/2606.00725)
...
### [2] [Constant-Stretch Rounding on the Hypersimplex](https://arxiv.org/abs/2606.00996)
...
### [3] [Dynamic Breadth First Search with Predictions](https://arxiv.org/abs/2606.01187)
...
### [4] [The anti-lexicographic SUS-anchor: a near-optimal k=1 sampling scheme](https://arxiv.org/abs/2606.01190)
...
### [5] [Multiagent Matroid Upgrading: Greedy is Fair and Efficient](https://arxiv.org/abs/2606.01309)
...
### [6] [On Thin Perfect Matchings up to Polylogarithmic Factors](https://arxiv.org/abs/2606.01330)
...
### [7] [Adversarial Configurations for the ReCom Transition Function](https://arxiv.org/abs/2606.01333)
*Micah Gold*
...
### [8] [Towards Optimal Robustness in Learning-Augmented Paging](https://arxiv.org/abs/2606.01342)
...
### [9] [A Near-Optimal Offline Algorithm for Dynamic All-Pairs Shortest Paths in Planar Digraphs](https://arxiv.org/abs/2606.01809)
...
### [10] [The Completion-Threshold Framework for Obligatory-Test Scheduling on Multiple Machines](https://arxiv.org/abs/2606.02029)
...
### [11] [Efficiently Listing Projected Trees, and Equivalence of Listing and Enumeration](https://arxiv.org/abs/2606.02183)
...
### [12] [Exact Sampling of Permutations with a Fixed Longest Increasing Subsequence](https://arxiv.org/abs/2606.02263)
...
### [13] [Terminal Steiner tree problem : Complexity and Algorithms](https://arxiv.org/abs/2606.02325)
...
### [14] [HeLoCo: Efficient asynchronous low-communication training under data and device heterogeneity](https://arxiv.org/abs/2606.00271)
...
### [15] [Augur: Pre-Execution Energy Prediction for Workflow Tasks in Heterogeneous Clusters](https://arxiv.org/abs/2606.00348)
...
### [16] [The Cartan-Topos Protocol: A Unified Geometric and Categorical Framework for Resilient Multi-Agent Coordination](https://arxiv.org/abs/2606.00714)
...
### [17] [ViBE: Co-Optimizing Workload Skew and Hardware Variability for MoE Serving](https://arxiv.org/abs/2606.00735)
...
### [18] [Lodestar: An Online-Learning LLM Inference Router](https://arxiv.org/abs/2606.00946)
...
### [20] [Leyline: KV Cache Directives for Agentic Inference](https://arxiv.org/abs/2606.01065)
...
### [21] [Magnum.np.distributed: Accelerating Finite Difference Micromagnetic Simulations with Multiple GPUs](https://arxiv.org/abs/2606.01114)
...
### [22] [Schedule-Level Shared-Prefix Reuse for LLM RL Training](https://arxiv.org/abs/2606.01143)
...
### [23] [AcOrch: Accelerating Sampling-based GNN Training under CPU-NPU Heterogeneous Environments](https://arxiv.org/abs/2606.01161)
...
### [24] [The World's Fastest Matching Engine Algorithm](https://arxiv.org/abs/2606.01183)
*Jake Yoon*
...
### [25] [Fail-Closed Lowering of Resident KV Claims onto LLM Serving Runtimes](https://arxiv.org/abs/2606.01387)
*Lukas Stepanek*
...
### [26] [Hierarchical Online Prompt Mutation with Dual-Loop Feedback for Guardrailed Evidence Document Generation: A Production-Evaluation Case Study](https://arxiv.org/abs/2606.01472)
...
### [27] [Move the Query, Not the Cache: Characterizing Cross-Instance Latent Attention Redistribution Across GPU Fabrics](https://arxiv.org/abs/2606.01502)
...
### [28] [Compliance-Scored Best-of-N Guardrail Orchestration for Multimodal Document Generation in Payments Dispute Defense](https://arxiv.org/abs/2606.01513)
*Nataraj Agaram Sundar,Tejas Morabia*
...
### [29] [Self-Conditioned Positional HNSW for Overlap-Aware Retrieval in Chunked-Document RAG Systems: Method and Industrial Evidence-Quality Audit](https://arxiv.org/abs/2606.01542)
*Nataraj Agaram Sundar,Tejas Morabia*
...
### [30] [TwinQuant: Learnable Subspace Decomposition for 4-Bit LLM Quantization](https://arxiv.org/abs/2606.01556)
...
### [31] [Scalable Concurrent Queues for GPU](https://arxiv.org/abs/2606.01693)
...
### [32] [Don't Let a Few Network Failures Slow the Entire AllReduce](https://arxiv.org/abs/2606.01680)
...
### [33] [Night-Window Batching versus Carbon-Aware Scheduling for Clinical AI GPU Workloads](https://arxiv.org/abs/2606.01766)
...
### [34] [Parallelizing Large-Scale Tensor Network Contraction on Multiple GPUs](https://arxiv.org/abs/2606.01852)
...
### [35] [Boosting Multimodal Federated Learning via Chained Modality Optimization](https://arxiv.org/abs/2606.01856)
...
### [36] [Scaling LLM Inference Beyond Amdahl`s Limits via Eliminating Non-Scalable Overheads](https://arxiv.org/abs/2606.01927)
...
### [37] [TAPAAL SMC: Statistical Model Checking of Stochastic Timed-Arc Petri Nets](https://arxiv.org/abs/2606.02007)
...
### [38] [EES-CND: Collaborative Neural Decision-Making for Drift-Aware Fault-Tolerant Edge-Cloud Service Placement](https://arxiv.org/abs/2606.02259)
...
### [39] [Strategies for Molecular Dynamics using Hybrid Systems: LAMMPS Use Case](https://arxiv.org/abs/2606.02319)
...
### [40] [Not All Errors Are Equal: A Systematic Study of Error Propagation in Large Language Model Inference](https://arxiv.org/abs/2606.02430)
...
### [41] [ScanWeaver: Compiler-Driven Parallelization of Affine Recurrences via Associative Scan Lowering](https://arxiv.org/abs/2606.00601)
...
### [42] [Grid Programs: A Two-Dimensional, Variable-Free Model of Computation](https://arxiv.org/abs/2606.00692)
...
### [43] [Exploiting Multiple Abstract Call Patterns for Optimizing Run-Time Checks](https://arxiv.org/abs/2606.01076)
...
### [44] [Type-Error Ablation and AI Coding Agents](https://arxiv.org/abs/2606.01522)
...
### [45] [Teaching Synchronous Dataflow Modelling with Learn-Heptagon](https://arxiv.org/abs/2606.01928)
...
### [46] [Toka: A Systems Programming Language with Explicit Resource Semantics](https://arxiv.org/abs/2606.01974)
*Zhonghua Yi*
...
### [47] [From Time to Space: The Impact of Linearity in Higher-Order Datalog](https://arxiv.org/abs/2606.02394)
...
### [48] [SPARQLe: Sub-Precision Activation Representation for Quantized LLM Inference](https://arxiv.org/abs/2606.00365)
...
### [49] [Regular-Dead on Arrival: Characterizing and Protecting Against Dead-Entry TLB Misses in GPU Microarchitectures](https://arxiv.org/abs/2606.00486)
...
### [50] [Regular-Activation Concentration: Characterizing Column-Level Output Sparsity Across Diffusion Model Architectures](https://arxiv.org/abs/2606.00567)
...
### [51] [LP5X-PIM Sim: A High-Fidelity HW/SW Integrated Simulator for LPDDR5X-PIM](https://arxiv.org/abs/2606.00636)
...
### [52] [Linear Complexity Fermionic Simulation on Quantum Devices with Hardware Connectivity Constraints](https://arxiv.org/abs/2606.00982)
...
### [53] [OpenEye: A Scalable Open-Source Hardware Accelerator for DNNs](https://arxiv.org/abs/2606.01450)
...
### [54] [O-POPE: High-Frequency Pipelined Outer Product based GEMM acceleration with minimal buffering overhead](https://arxiv.org/abs/2606.02333)
...
### [55] [CHIMERA: A Flexible and Scalable 3.1 TOPS/W AI-MCU with Transformer Accelerator and 563 Gb/s Shared-L2 Memory Subsystem with QoS Guarantees](https://arxiv.org/abs/2606.02358)
