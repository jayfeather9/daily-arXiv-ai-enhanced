...
### [9] [Shift-Accumulate Attention: Multiplier-Free Query--Key Products for Transformer Decoding](https://arxiv.org/abs/2609.09208)
...
### [10] [Academia x Industry: The Role of Fundamentals for Silicon in an AI Native Era](https://arxiv.org/abs/2609.09344)
...
### [11] [HLSFactory-Agent: Large-Scale Agentic HLS Dataset Construction from Academic and Open-Source Projects](https://arxiv.org/abs/2609.09519)
...
### [12] [Benchmarking Agentic HLS Design Tasks With HLS-Eval](https://arxiv.org/abs/2609.09526)
...
### [13] [Differential Stochastic Simulated Annealing Processor for Fully Connected 2048-Spin Optimization](https://arxiv.org/abs/2609.09559)
...
### [14] [UNISON: A Co-Designed Near-Memory Scheduler of Session KV Residency for LLM Agents](https://arxiv.org/abs/2609.09643)
...
### [15] [Minimal Deadlock-Free Routing for Degree-Six Triangular-Lattice Meshes and Tori with Two Forbidden Turns](https://arxiv.org/abs/2609.09746)
...
### [16] [HBFSim: Fast and Faithful Simulation of High-Bandwidth Flash Under Real GPU Execution](https://arxiv.org/abs/2609.09800)
...
### [17] [AMEND: Audited Margins Enable Nonblocking Drops in GPU-PIM LLM Decoding](https://arxiv.org/abs/2609.09823)
...
### [18] [SAGE: Semantic-Aware Geographic Error Recovery for AI Data Movement](https://arxiv.org/abs/2609.10126)
...
### [19] [CertiFlash: A Formal Verification Framework for Flash Translation Layers in Computational Solid State Drives](https://arxiv.org/abs/2609.10347)
...
### [20] [UnsafeChecker: Finding Soundness Bugs in Rust Safe Abstractions](https://arxiv.org/abs/2609.09641)
...
### [21] [LBFAST: A Lightweight Moment-Represented Lattice Boltzmann Solver for Multi-GPU Architectures](https://arxiv.org/abs/2609.09160)
...
### [22] [SMCC-Empowered Digital Twins for Sensorless Monitoring in Large-Scale AI-Driven IoT Systems](https://arxiv.org/abs/2609.09161)
*Vincenzo Sammartino*
...
### [23] [HELIOS: Guardrailed LLM-Driven Evolution of Autonomous Resource Orchestration Policies for Multi-Cloud Distributed Systems](https://arxiv.org/abs/2609.09164)
...
### [24] [TFR-GNN: Topology- and Fault-Aware Graph Neural Scheduling for Heterogeneous Distributed Computing Systems](https://arxiv.org/abs/2609.09165)
...
### [25] [Smart Adaptive Computing Across the Continuum: LLMs in IoT-Edge-Cloud Resource Management](https://arxiv.org/abs/2609.09348)
...
### [26] [Introvert Clustering for Distributed Graph Algorithms](https://arxiv.org/abs/2609.10044)
...
### [27] [Breaking Fault Lines: Unifying TEE-Assisted BFT Consensus in Partially Trusted Worlds](https://arxiv.org/abs/2609.09742)
...
### [28] [Epoch: Compiling Diffusion Blocks for Sparse MoE Serving](https://arxiv.org/abs/2609.09748)
...
### [29] [CEDD-optimizer: Enabling Cost-Efficient Dataset Distillation on Geographically Distributed Edge Systems](https://arxiv.org/abs/2609.10151)
...
### [30] [Stencil Computation at the Intersection of AI and HPC](https://arxiv.org/abs/2609.10368)
...
### [31] [Avatar: Toward Autonomous End-to-End Orchestration of Scientific Workflows using LLMs](https://arxiv.org/abs/2609.10509)
