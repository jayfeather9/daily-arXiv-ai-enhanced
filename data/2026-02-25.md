...
### [1] [Exploiting Low-Rank Structure in Max-K-Cut Problems](https://arxiv.org/abs/2602.20376)
...
### [2] [Turing Completeness of GNU find: From mkdir-assisted Loops to Standalone Computation](https://arxiv.org/abs/2602.20762)
*Keigo Oka*
...
### [3] [DRESS: A Continuous Framework for Structural Graph Refinement](https://arxiv.org/abs/2602.20833)
...
### [4] [Adversarial Robustness on Insertion-Deletion Streams](https://arxiv.org/abs/2602.20854)
...
### [5] [A $2$-branching construction for the $χ\leq 2r$ bound](https://arxiv.org/abs/2602.20949)
...
### [6] [A Space-space Trade-off for Directed st-Connectivity](https://arxiv.org/abs/2602.21088)
*Roman Edenhofer*
...
### [7] [Frontier Space-Time Algorithms Using Only Full Memory](https://arxiv.org/abs/2602.21089)
...
### [8] [Analyzing Latency Hiding and Parallelism in an MLIR-based AI Kernel Compiler](https://arxiv.org/abs/2602.20204)
...
### [9] [DeCo: A Core Calculus for Incremental Functional Programming with Generic Data Types](https://arxiv.org/abs/2602.20866)
...
### [10] [SegSEM: Enabling and Enhancing SAM2 for SEM Contour Extraction](https://arxiv.org/abs/2602.20471)
...
### [11] [FAST-Prefill: FPGA Accelerated Sparse Attention for Long Context LLM Prefill](https://arxiv.org/abs/2602.20515)
...
### [12] [TOM: A Ternary Read-only Memory Accelerator for LLM-powered Edge Intelligence](https://arxiv.org/abs/2602.20662)
...
### [13] [LUTstructions: Self-loading FPGA-based Reconfigurable Instructions](https://arxiv.org/abs/2602.20802)
...
### [14] [The Tragedy of Chain Commons](https://arxiv.org/abs/2602.20341)
...
### [15] [Circumventing the FLP Impossibility Result with Open Atomic Ethernet](https://arxiv.org/abs/2602.20444)
*Paul Borrill*
...
### [16] [Heterogeneity-Aware Client Selection Methodology For Efficient Federated Learning](https://arxiv.org/abs/2602.20450)
...
### [17] [A Granularity Characterization of Task Scheduling Effectiveness](https://arxiv.org/abs/2602.20561)
...
### [18] [Lagom: Unleashing the Power of Communication and Computation Overlapping for Distributed LLM Training](https://arxiv.org/abs/2602.20656)
...
### [19] [A Morton-Type Space-Filling Curve for Pyramid Subdivision and Hybrid Adaptive Mesh Refinement](https://arxiv.org/abs/2602.20887)
...
### [20] [Is a LOCAL algorithm computable?](https://arxiv.org/abs/2602.21022)
...
### [21] [ReviveMoE: Fast Recovery for Hardware Failures in Large-Scale MoE LLM Inference Deployments](https://arxiv.org/abs/2602.21140)
...
### [22] [Circumventing the CAP Theorem with Open Atomic Ethernet](https://arxiv.org/abs/2602.21182)
*Paul Borrill*
