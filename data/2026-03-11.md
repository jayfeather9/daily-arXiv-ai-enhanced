...
### [2] [A Hybrid Residue Floating Numerical Architecture with Formal Error Bounds for High Throughput FPGA Computation](https://arxiv.org/abs/2603.08712)
*Mostafa Darvishi*
...
### [3] [Unveiling the Potential of Quantization with MXFP4: Strategies for Quantization Error Reduction](https://arxiv.org/abs/2603.08713)
...
### [10] [ALADIN: Accuracy-Latency-Aware Design-space Inference Analysis for Embedded AI Accelerators](https://arxiv.org/abs/2603.08722)
...
### [11] [PhD Thesis Summary: Methods for Reliability Assessment and Enhancement of Deep Neural Network Hardware Accelerators](https://arxiv.org/abs/2603.08724)
*Mahdi Taheri*
...
### [12] [Performance Analysis of Edge and In-Sensor AI Processors: A Comparative Review](https://arxiv.org/abs/2603.08725)
...
### [13] [Data-Rate-Aware High-Speed CNN Inference on FPGAs](https://arxiv.org/abs/2603.08726)
...
### [25] [RSH-SpMM: A Row-Structured Hybrid Kernel for Sparse Matrix-Matrix Multiplication on GPUs](https://arxiv.org/abs/2603.08734)
...
### [26] [Benchmarking Federated Learning in Edge Computing Environments: A Systematic Review and Performance Evaluation](https://arxiv.org/abs/2603.08735)
...
### [27] [Autonomous Edge-Deployed AI Agents for Electric Vehicle Charging Infrastructure Management](https://arxiv.org/abs/2603.08736)
*Mohammed Cherifi*
...
### [28] [Zipage: Maintain High Request Concurrency for LLM Reasoning through Compressed PagedAttention](https://arxiv.org/abs/2603.08743)
...
### [29] [Extension of ACETONE C code generator for multi-core architectures](https://arxiv.org/abs/2603.08744)
...
### [30] [Serving Compound Inference Systems on Datacenter GPUs](https://arxiv.org/abs/2603.08797)
...
### [31] [DeZent: Decentralized z-Anonymity with Privacy-Preserving Coordination](https://arxiv.org/abs/2603.08854)
...
### [32] [FedLECC: Cluster- and Loss-Guided Client Selection for Federated Learning under Non-IID Data](https://arxiv.org/abs/2603.08911)
...
### [33] [Accelerating High-Order Finite Element Simulations at Extreme Scale with FP64 Tensor Cores](https://arxiv.org/abs/2603.09038)
...
### [34] [Nezha: A Key-Value Separated Distributed Store with Optimized Raft Integration](https://arxiv.org/abs/2603.09122)
...
### [35] [Hierarchical Observe-Orient-Decide-Act Enabled UAV Swarms in Uncertain Environments: Frameworks, Potentials, and Challenges](https://arxiv.org/abs/2603.09191)
...
### [36] [PIM-SHERPA: Software Method for On-device LLM Inference by Resolving PIM Memory Attribute and Layout Inconsistencies](https://arxiv.org/abs/2603.09216)
...
### [37] [Flash-KMeans: Fast and Memory-Efficient Exact K-Means](https://arxiv.org/abs/2603.09229)
...
### [38] [Case Study: Performance Analysis of a Virtualized XRootD Frontend in Large-Scale WAN Transfers](https://arxiv.org/abs/2603.09568)
...
### [39] [Multi-DNN Inference of Sparse Models on Edge SoCs](https://arxiv.org/abs/2603.09642)
...
### [40] [bsort: A theoretically efficient non-comparison-based sorting algorithm for integer and floating-point numbers](https://arxiv.org/abs/2603.08929)
*Benjamín Guzmán*
...
### [41] [Unit Interval Selection in Random Order Streams](https://arxiv.org/abs/2603.08937)
...
### [42] [A PTAS for Weighted Triangle-free 2-Matching](https://arxiv.org/abs/2603.09144)
...
### [43] [Fast and Optimal Differentially Private Frequent-Substring Mining](https://arxiv.org/abs/2603.09166)
...
### [44] [On the Online Weighted Non-Crossing Matching Problem](https://arxiv.org/abs/2603.09262)
