...
### [3] [An $O(n^5)$-Time Algorithm for Optimal Broadcast Domination](https://arxiv.org/abs/2605.20526)
...
### [4] [Creating Robust and Fair Graph Structures for Connectivity and Clustering](https://arxiv.org/abs/2605.20897)
*Kushagra Chatterjee*
...
### [5] [Distributed Stochastic Graph Algorithms](https://arxiv.org/abs/2605.21248)
...
### [6] [pace-Time Trade-off in Integer Linear Scaling Rounded to the Nearest Integer through Multiplicative and Additive Decomposition](https://arxiv.org/abs/2605.21400)
*Kyeong Soo Kim*
...
### [7] [Hypergraph Partitioning on GPU with Distinct Incident Hyperedges and Size Constraints](https://arxiv.org/abs/2605.20497)
...
### [8] [Hybrid Edge-HPC Systems for Low-Latency Data-Driven Inference](https://arxiv.org/abs/2605.20532)
...
### [13] [Diagnosing Overhead in Dispatch Operations: Cross-architecture Observatory](https://arxiv.org/abs/2605.20982)
...
### [14] [NanoCP: Request-Level Dynamic Context Parallelism for Data-Expert Parallel Decoding](https://arxiv.org/abs/2605.21100)
...
### [15] [Automated Byzantine-Resilient Clustered Decentralized Federated Learning for Battery Intelligence in Connected EVs](https://arxiv.org/abs/2605.21115)
...
### [16] [Frontier: Towards Comprehensive and Accurate LLM Inference Simulation](https://arxiv.org/abs/2605.21312)
...
### [17] [Multicategorical Semantics for Untyped Effects](https://arxiv.org/abs/2605.21337)
