...
### [10] [Mitigating High-Frequency Geometric Noise in Non-Parametric 1-Bit Sparse](https://arxiv.org/abs/2606.26137)
*Lars Kopp*
...
### [12] [Toward Mitigating Process-Induced Performance Degradation in 3.5D Heterogeneous Packages via Pre-Silicon Firmware Co-Optimization](https://arxiv.org/abs/2606.26176)
...
### [13] [CVA6-RT: an Open-Source Time-Predictable RV64 Processor for Mixed-Criticality Systems](https://arxiv.org/abs/2606.26177)
...
### [14] [Nanoelectromechanical Systems (NEMS) for Hardware Security in Advanced Packaging](https://arxiv.org/abs/2606.26426)
...
### [15] [GRAINS: Storage-Aware Algorithm-Architecture Co-Design Enabling High-Performance and Low-Cost Graph-Based Genome Analysis](https://arxiv.org/abs/2606.26468)
...
### [16] [SegFold: Accelerating Sparse GEMM with a Fine-Grained Dynamic Dataflow](https://arxiv.org/abs/2606.26701)
...
### [17] [Residual GPU Cache State on Apple M4 Pro](https://arxiv.org/abs/2606.27098)
...
### [18] [Evaluating Architectural Trade-offs in CGRAs: The Impact of Scratchpad Memory and Heterogeneity on Compute-Intensive Kernels](https://arxiv.org/abs/2606.27240)
...
### [19] [CHIA: An open-source framework for principled, agentic AI-driven hardware/software co-design research](https://arxiv.org/abs/2606.27350)
...
### [20] [Structural parameterizations of Geodetic Set on directed (acyclic) graphs](https://arxiv.org/abs/2606.26414)
...
### [21] [Almost Optimal Multiple Source Shortest Paths and Reachability](https://arxiv.org/abs/2606.26554)
...
### [22] [Fast Enumeration of Minimal Removable Sets in Monotone Systems with Application to Core Collapse Analysis](https://arxiv.org/abs/2606.26639)
...
### [23] [Fast algorithms for learning a Gaussian under halfspace truncation with optimal sample complexity](https://arxiv.org/abs/2606.27298)
...
### [24] [Axon: A Synthesizing Superoptimizer for Tensor Programs](https://arxiv.org/abs/2606.26344)
...
### [25] [A Typestate Approach to Purpose-aware Programming](https://arxiv.org/abs/2606.26386)
...
### [26] [Compiler-Driven Approximation Tuning for Hyperdimensional Computing](https://arxiv.org/abs/2606.26547)
...
### [27] [Mostly Automatic Translation of Language Interpreters from C to Safe Rust](https://arxiv.org/abs/2606.27122)
...
### [28] [Welterweight Go: Boxing, Structural Subtyping, and Generics (Extended Version)](https://arxiv.org/abs/2606.27138)
