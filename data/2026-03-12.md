...
### [1] [Transposition is Nearly Optimal for IID List Update](https://arxiv.org/abs/2603.10244)
*Christian Coester*
...
### [2] [Reconstructing Bounded Treelength Graphs with Linearithmic Shortest Path Distance Queries](https://arxiv.org/abs/2603.10432)
...
### [3] [Density-Dependent Graph Orientation and Coloring in Scalable MPC](https://arxiv.org/abs/2603.10639)
...
### [4] [Intermittent Cauchy walks enable optimal 3D search across target shapes and sizes](https://arxiv.org/abs/2603.10655)
...
### [5] [Sublinear-Time Reconfiguration of Programmable Matter with Joint Movements](https://arxiv.org/abs/2603.10720)
...
### [6] [Sample-and-Search: An Effective Algorithm for Learning-Augmented k-Median Clustering in High dimensions](https://arxiv.org/abs/2603.10721)
...
### [7] [Huffman-Bucket Sketch: A Simple $O(m)$ Algorithm for Cardinality Estimation](https://arxiv.org/abs/2603.10930)
*Matti Karppa*
...
### [8] [Simple minimally unsatisfiable subsets of 2-CNFs](https://arxiv.org/abs/2603.10944)
...
### [9] [RedFuser: An Automatic Operator Fusion Framework for Cascaded Reductions on AI Accelerators](https://arxiv.org/abs/2603.10026)
...
### [10] [The DMA Streaming Framework: Kernel-Level Buffer Orchestration for High-Performance AI Data Paths](https://arxiv.org/abs/2603.10030)
*Marco Graziano*
...
### [11] [Architecture-Aware LLM Inference Optimization on AMD Instinct GPUs: A Comprehensive Benchmark and Deployment Study](https://arxiv.org/abs/2603.10031)
*Athos Georgiou*
...
### [12] [HTM-EAR: Importance-Preserving Tiered Memory with Hybrid Routing under Saturation](https://arxiv.org/abs/2603.10032)
*Shubham Kumar Singh*
...
### [13] [Multi-Agent Memory from a Computer Architecture Perspective: Visions and Challenges Ahead](https://arxiv.org/abs/2603.10062)
...
### [14] [Pooling Engram Conditional Memory in Large Language Models using CXL](https://arxiv.org/abs/2603.10087)
...
### [15] [In-Memory ADC-Based Nonlinear Activation Quantization for Efficient In-Memory Computing](https://arxiv.org/abs/2603.10540)
...
### [16] [An FPGA Implementation of Displacement Vector Search for Intra Pattern Copy in JPEG XS](https://arxiv.org/abs/2603.10671)
...
### [23] [Fully Symbolic Analysis of Loop Locality: Using Imaginary Reuse to Infer Real Performance](https://arxiv.org/abs/2603.10196)
