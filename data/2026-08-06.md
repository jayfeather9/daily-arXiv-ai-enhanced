...
### [1] [Concentration from Product Moments via an Additional Element of Randomness](https://arxiv.org/abs/2608.04125)
...
### [2] [Bicriteria Approximation Algorithms for Demand Matching](https://arxiv.org/abs/2608.04223)
...
### [3] [Multi-Level Aggregation via Dual Fitting: An $O(D)$-Competitive Algorithm](https://arxiv.org/abs/2608.04258)
...
### [4] [Bottleneck Paths Reduce to Deterministic Graphical Games: A Correction to a Claimed Linear-Time Algorithm](https://arxiv.org/abs/2608.04279)
*Egor Gorbachev*
...
### [5] [The Greedy Binary Search Tree is Non-trivially Competitive](https://arxiv.org/abs/2608.04410)
...
### [6] [Taming Treewidth DP with Modulators: A General Booster for Graph Heuristics](https://arxiv.org/abs/2608.04446)
...
### [7] [A Separator-based Algorithm for the Graph Edit Distance Problem](https://arxiv.org/abs/2608.04583)
...
### [8] [Cluster Deletion is as Hard to Approximate as Vertex Cover](https://arxiv.org/abs/2608.04883)
*Yixin Cao,Ying Xu*
...
### [9] [A Tight Bound on Online Vertex Cover under Edge Arrivals](https://arxiv.org/abs/2608.04994)
...
### [10] [Exact simulation of diffusions and improved algorithms for log-concave sampling](https://arxiv.org/abs/2608.05022)
...
### [11] [If it is Good Then Drop it -- a Spiteful Poisson Process for Submodular Maximization](https://arxiv.org/abs/2608.05062)
...
### [12] [A Distributed Quantum Approximate Optimization Algorithm For Unit Commitment](https://arxiv.org/abs/2608.04159)
...
### [13] [Zero-Instrumentation Dependency Discovery for Guided Microservice Migration Using eBPF](https://arxiv.org/abs/2608.04413)
...
### [14] [CommBench: Can LLMs Write Correct and Efficient GPU Communication Code?](https://arxiv.org/abs/2608.04450)
...
### [15] [AFD-Ledger: Deployment Provisioning for Attention--FFN Disaggregation](https://arxiv.org/abs/2608.04502)
...
### [16] [AsymSpec: Efficient Cloud-Edge Speculative Decoding over Asymmetric Networks](https://arxiv.org/abs/2608.04974)
...
### [17] [RAC: Reference-Aware Activation Compression for Communication-Efficient Split LLM Inference](https://arxiv.org/abs/2608.04991)
...
### [18] [SparseDitto: Customizing GPU Kernels for Different Sparsity Patterns with LLM-Based Agentic System](https://arxiv.org/abs/2608.05033)
...
### [19] [Multi-Mode Debugging for FRP-Based Embedded Systems](https://arxiv.org/abs/2608.04264)
...
### [20] [Accelerating C/C++ Pointer Analysis via Compiler-Based Offline Simplifications](https://arxiv.org/abs/2608.04466)
...
### [21] [Towards Datalog on Quantum Annealers: Compiling Recursive Logic Programs with Bottom-up Semantics to 2-local Ising Models](https://arxiv.org/abs/2608.04645)
...
### [22] [Hardware-Enabled Fuzzy Inference: Architectures, Platforms, and Emerging Trends](https://arxiv.org/abs/2608.04031)
...
### [23] [EDATracer: An Agentic Framework for Large-Scale EDA Artifact Analysis](https://arxiv.org/abs/2608.04032)
...
### [24] [CheckOne: Lightweight Fault Detection and Mitigation for Vision Transformers](https://arxiv.org/abs/2608.04035)
...
### [25] [A Symbolic Execution Framework for Symbolic Timing Analysis of Digital Integrated Circuits](https://arxiv.org/abs/2608.04036)
...
### [26] [MCHA: A Memory-Centric Hierarchical Architecture for Parallel-Sequential Computing](https://arxiv.org/abs/2608.04443)
...
### [27] [On Design Principles for Efficient Heterogeneous DRAM-PIM-GPU Systems](https://arxiv.org/abs/2608.04169)
...
### [28] [A Centralized Performance Monitoring Architecture for Heterogeneous Multicore SoCs](https://arxiv.org/abs/2608.04247)
...
### [29] [Deltoris: Enabling Real-time VLA Inference in Embodied AI via Bit-level Sparsity and Speculative Inference](https://arxiv.org/abs/2608.04428)
...
### [30] [A Systolic Array Architecture for Nonlinear Activation Functions and Softmax Computation using Chebyshev Polynomials](https://arxiv.org/abs/2608.04734)
