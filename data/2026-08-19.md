...
### [1] [Brief Announcement: Fair Binding for Hidden-State Authorization in Byzantine SMR](https://arxiv.org/abs/2608.17349)
*Arnab Mallick*
...
### [2] [Generalizing and accelerating consistency checking for non-transactional distributed storage systems](https://arxiv.org/abs/2608.17388)
...
### [3] [Optimal Adaptive Multi-Valued Byzantine Agreement](https://arxiv.org/abs/2608.17552)
...
### [4] [Counting in Population Protocols on Graphs](https://arxiv.org/abs/2608.17590)
...
### [5] [Bounded-State Restoration: Decoupling Local Restore Capacity from External LLM State](https://arxiv.org/abs/2608.17826)
*Zixuan Li*
...
### [6] [Multivalued Consensus: General Adversaries Require More Communication](https://arxiv.org/abs/2608.17998)
...
### [7] [Minimizing Commit Rules for DAG-based Atomic Broadcast](https://arxiv.org/abs/2608.18029)
...
### [8] [Average Distance Approximation for Static Large Graphs](https://arxiv.org/abs/2608.16916)
*Kartikey Ahlawat*
...
### [9] [A Tight Linear Deterministic Competitive Ratio for Fully Online KV-Cache Scheduling](https://arxiv.org/abs/2608.16944)
*Ian D'Ambrosio*
...
### [10] [A Constant-Competitive Algorithm for Dynamic Mixture-of-Experts Serving](https://arxiv.org/abs/2608.16947)
*Ian D'Ambrosio*
...
### [11] [A Black-Box Workload Barrier for Exact Girth via Multi-Scale Nearest-Source Estimation in CONGEST](https://arxiv.org/abs/2608.17358)
...
### [12] [Maximum Flow Without the Outer IPM](https://arxiv.org/abs/2608.17384)
*Jason Li,Alex Wice*
...
### [13] [Parameterized complexity of $k$-Coloring in graphs with no long induced paths](https://arxiv.org/abs/2608.17835)
*Paweł Rzążewski*
...
### [14] [Average-Case Optimal Encodings and Efficient Worst-Case Indices for Element Distinctness Queries](https://arxiv.org/abs/2608.17907)
...
### [15] [Cluster-Graph Edit Distance: Metric Proxies, Multiscale Embeddings, and Complexity](https://arxiv.org/abs/2608.17990)
...
### [16] [SeqFeed: Improving Agentic RTL Code Generation with Sequential Behavior Feedback](https://arxiv.org/abs/2608.16934)
...
### [17] [DTX: A Throughput-First Training Accelerator for Diffusion and Transformer Models](https://arxiv.org/abs/2608.16953)
*Shashank*
...
### [18] [RENESIS: Energy-Aware Synthesis of Adiabatic Logic from Irreversible Netlists](https://arxiv.org/abs/2608.17139)
*Mitchell A. Thornton*
...
### [19] [The Road Less Traveled: Congestion-Aware NoC Placement and Packet Routing for FPGAs](https://arxiv.org/abs/2608.17266)
...
### [20] [NeuroAbs: A Neuro-Symbolic RTL Abstraction Framework for Property Checking Acceleration](https://arxiv.org/abs/2608.17304)
...
### [21] [ETHEREAL: A 25.6-$μ$s/inf. Low-latency Event-driven Graph-neural-network Processor for High-resolution Vision at the Edge](https://arxiv.org/abs/2608.17787)
...
### [22] [ESR-HGNN: Eliminating Semantic Redundancy for Efficient Mini-batch HGNN Inference](https://arxiv.org/abs/2608.17865)
