...
### [9] [Canonical LST: A Protocol-Native Liquid Staking Solution for Tezos](https://arxiv.org/abs/2605.00828)
...
### [10] [Efficient Accelerated Graph Edit Distance Computation on GPU](https://arxiv.org/abs/2605.00830)
...
### [11] [GhostServe: A Lightweight Checkpointing System in the Shadow for Fault-Tolerant LLM Serving](https://arxiv.org/abs/2605.00831)
...
### [12] [SCION: Size-aware Policy Orchestration for Nonstationary Object Caches (Long Paper Version)](https://arxiv.org/abs/2605.01055)
*Qizhi Wang*
...
### [14] [FPTC: A Fast Parallel Transform-based Codec for Efficient Asymmetric Signal Compression](https://arxiv.org/abs/2605.01086)
...
### [15] [Position: LLM Serving Needs Mathematical Optimization and Algorithmic Foundations, Not Just Heuristics](https://arxiv.org/abs/2605.01280)
*Zijie Zhou*
...
### [16] [CvxCluster: Solving Large, Complex, Granular Resource Allocation Problems 100-1000x Faster](https://arxiv.org/abs/2605.01614)
...
### [17] [SplitZip: Ultra Fast Lossless KV Compression for Disaggregated LLM Serving](https://arxiv.org/abs/2605.01708)
...
### [18] [Joint Temporal-Structural Representation Learning for Distributed Fault Discrimination in Microservice Architectures](https://arxiv.org/abs/2605.01776)
...
### [19] [nvPAX: Constrained Optimization for Dynamic Power Allocation in Hierarchical and Multi-Tenant Systems](https://arxiv.org/abs/2605.01837)
...
### [20] [Decentralized Stratified Sampling for Low-Latency Approximate Geospatial Data Stream Processing in Edge-Cloud Architectures](https://arxiv.org/abs/2605.01922)
...
### [21] [Cross-Layer Energy Analysis of Multimodal Training on Grace Hopper Superchips](https://arxiv.org/abs/2605.01938)
...
### [22] [FedQueue: Queue-Aware Federated Learning for Cross-Facility HPC Training](https://arxiv.org/abs/2605.02125)
...
### [23] [AAFLOW: Scalable Patterns for Agentic AI Workflows](https://arxiv.org/abs/2605.02162)
...
### [24] [PipeMax: Enhancing Offline LLM Inference on Commodity GPU Servers](https://arxiv.org/abs/2605.02189)
...
### [25] [A Treasure Trove of Performance: Analyzing the IO500 Submission Data](https://arxiv.org/abs/2605.02194)
...
### [26] [Leveraging Teaching on Demand: Approaching HPC to Undergrads](https://arxiv.org/abs/2605.02217)
...
### [27] [Taming Request Imbalance: SLO-Aware Scheduling for Disaggregated LLM Inference](https://arxiv.org/abs/2605.02329)
...
### [28] [FedPLT: Scalable, Resource-Efficient, and Heterogeneity-Aware Federated Learning via Partial Layer Training](https://arxiv.org/abs/2605.02337)
...
### [29] [Caliper-in-the-Loop: Black-Box Optimization for Hyperledger Fabric Performance Tuning](https://arxiv.org/abs/2605.02690)
...
### [30] [Assessing Performance and Porting Strategies for Gravitational $N$-Body Simulations on the RISC-V-Based Tenstorrent Wormhole\textsuperscript{\texttrademark}](https://arxiv.org/abs/2605.02744)
...
### [31] [(POSTER) From Sensors to Insight: Rapid, Edge-to-Core Application Development for Sensor-Driven Applications](https://arxiv.org/abs/2605.02844)
...
### [32] [From Sensors to Insight: Rapid, Edge-to-Core Application Development for Sensor-Driven Applications](https://arxiv.org/abs/2605.02859)
*Komal Thareja,Anirban Mandal,Ewa Deelman*
...
### [33] [Practical Formal Verification for MLIR Programs](https://arxiv.org/abs/2605.01124)
...
### [34] [SoCal: A Language for Memory-Layout Factorization of Recursive Datatypes](https://arxiv.org/abs/2605.01140)
...
### [35] [FlowBook: Enforcing Reproducibility in Computational Notebooks](https://arxiv.org/abs/2605.01560)
...
### [36] [Testing, Credible Compilation, and Verification in the Axon Verified Compiler in Lean and Claude Code](https://arxiv.org/abs/2605.01660)
*Martin Rinard*
...
### [37] [How to benchmark: the Measure-Explain-Test-Improve loop](https://arxiv.org/abs/2605.02233)
*Gabriel Scherer*
...
### [38] [Compile-Time Java Stream Fusion via mapMulti](https://arxiv.org/abs/2605.02691)
...
### [39] [Compositional Neural-Cyber-Physical System Verification in the Interactive Theorem Prover of Your Choice](https://arxiv.org/abs/2605.02790)
...
### [40] [New Bounds for Kernel Sums via Fast Spherical Embeddings](https://arxiv.org/abs/2605.01263)
*Tal Wagner*
...
### [41] [A Unified Approach to Minimizing Symmetric Submodular Functions](https://arxiv.org/abs/2605.01473)
...
### [42] [Randomized $k$-server in polynomial time](https://arxiv.org/abs/2605.01497)
...
### [43] [A fine-grained dichotomy for the center problem on Gromov hyperbolic graphs](https://arxiv.org/abs/2605.01578)
*Guillaume Ducoffe*
...
### [44] [Undirected Replacement Paths: Dual Fault Reduces to Single Source](https://arxiv.org/abs/2605.02114)
...
### [45] [On the power of standard DFS and BFS](https://arxiv.org/abs/2605.02387)
...
### [46] [A Polynomial Kernel for Vertex Deletion to the Scattered Class of Proper Interval Graph and Trees](https://arxiv.org/abs/2605.02399)
...
### [47] [Ranking with Partitioning](https://arxiv.org/abs/2605.02874)
*Samuel Boardman*
