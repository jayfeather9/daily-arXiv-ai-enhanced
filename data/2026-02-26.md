...
### [3] [Precedence-Constrained Decision Trees and Coverings](https://arxiv.org/abs/2602.21312)
...
### [4] [DRESS and the WL Hierarchy: Climbing One Deletion at a Time](https://arxiv.org/abs/2602.21557)
...
### [5] [Maximal Biclique Enumeration with Improved Worst-Case Time Complexity Guarantee: A Partition-Oriented Strategy](https://arxiv.org/abs/2602.21700)
...
### [6] [Delayed-Clairvoyant Flow Time Scheduling via a Borrow Graph Analysis](https://arxiv.org/abs/2602.21827)
...
### [7] [Instance-optimal estimation of L2-norm](https://arxiv.org/abs/2602.21937)
*Tomer Adar*
...
### [8] [Tight Bounds for Online Scheduling in the One-Fast-Many-Slow Machines Setting](https://arxiv.org/abs/2602.22108)
...
### [9] [Robust Permutation Flowshops Under Budgeted Uncertainty](https://arxiv.org/abs/2602.22110)
...
### [10] [General Convex Agreement with Near-Optimal Communication](https://arxiv.org/abs/2602.21411)
...
### [11] [DualPath: Breaking the Storage Bandwidth Bottleneck in Agentic LLM Inference](https://arxiv.org/abs/2602.21548)
...
### [12] [Multi-Layer Scheduling for MoE-Based LLM Reasoning](https://arxiv.org/abs/2602.21626)
...
### [13] [Lamport's Arrow of Time: The Category Mistake in Logical Clocks](https://arxiv.org/abs/2602.21730)
*Paul Borrill*
...
### [14] [DHP: Efficient Scaling of MLLM Training with Dynamic Hybrid Parallelism](https://arxiv.org/abs/2602.21788)
...
### [15] [A task-based data-flow methodology for programming heterogeneous systems with multiple accelerator APIs](https://arxiv.org/abs/2602.21897)
...
### [16] [Energy Efficient Federated Learning with Hyperdimensional Computing over Wireless Communication Networks](https://arxiv.org/abs/2602.21949)
...
### [17] [IOAgent: Democratizing Trustworthy HPC I/O Performance Diagnosis Capability via LLMs](https://arxiv.org/abs/2602.22017)
...
### [18] [PASTA: A Modular Program Analysis Tool Framework for Accelerators](https://arxiv.org/abs/2602.22103)
...
### [19] [Heterogeneous Memory Design Exploration for AI Accelerators with a Gain Cell Memory Compiler](https://arxiv.org/abs/2602.21278)
