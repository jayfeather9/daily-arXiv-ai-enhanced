...
### [6] [Tree Search With Predictions](https://arxiv.org/abs/2605.27490)
...
### [7] [Proper Agnostic Learning of Functions of Halfspaces under Gaussian Marginals](https://arxiv.org/abs/2605.27594)
...
### [8] [Smoothed Score Queries and the Complexity of Sampling](https://arxiv.org/abs/2605.27769)
*Jingbo Liu*
...
### [9] [Efficient Algorithms for Interdicting Facilities in Trees and Bounded Treewidth Graphs](https://arxiv.org/abs/2605.27998)
...
### [10] [A Deterministic Separation Lemma](https://arxiv.org/abs/2605.28138)
*Abhishek Sahu*
...
### [11] [High-Quality Multi-Constraint Hypergraph Partitioning via Greedy Rebalancing](https://arxiv.org/abs/2605.28333)
*Nikolai Maas*
...
### [12] [Agentic Separation Logic Specification Synthesis](https://arxiv.org/abs/2605.27531)
...
### [13] [FPMoE: A Sparse Mixture-of-Experts Approach to Functional Code Generation](https://arxiv.org/abs/2605.27849)
...
### [14] [Skill-as-Pseudocode: Refactoring Skill Libraries to Pseudocode for LLM Agents](https://arxiv.org/abs/2605.27955)
...
### [15] [E-Path: Equality Saturation for Control-Flow Graphs](https://arxiv.org/abs/2605.28694)
*Guillermo Garcia*
...
### [16] [Context-aware Simopt-Power: Using structural data with simulation metadata to optimise FPGA designs](https://arxiv.org/abs/2605.27446)
...
### [17] [A Methodology to Assess Power Modeling in Energy-Aware Federated Learning on Heterogeneous Mobile Devices](https://arxiv.org/abs/2605.27601)
...
### [18] [Carbon-Aware Mapping and Scheduling for Deadline-Constrained Workflows](https://arxiv.org/abs/2605.27652)
...
### [19] [SOLANET: Distributed Neighbor Graph Construction on GPU-Accelerated Systems](https://arxiv.org/abs/2605.27691)
...
### [20] [Addressing Variable Heterogeneity in Distributed Multimodal Training with Entrain](https://arxiv.org/abs/2605.27918)
...
### [21] [SiDP: Memory-Efficient Data Parallelism for Offline LLM Inference](https://arxiv.org/abs/2605.28095)
...
### [22] [Resource Allocation in HyperX Networks](https://arxiv.org/abs/2605.28205)
...
### [23] [TrioSeq: A Novel Approach to Accelerate Triplet Sequence Alignment on GPUs](https://arxiv.org/abs/2605.28400)
