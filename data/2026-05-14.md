...
### [10] [A detailed algorithmic study on a reuse-aware, near memory, all-digital Ising machine](https://arxiv.org/abs/2605.12959)
...
### [11] [PoisonCap: Efficient Hierarchical Temporal Safety for CHERI](https://arxiv.org/abs/2605.13210)
...
### [12] [FPGA-Accelerated Lock Management and Transaction Processing: Architecture, Optimization, and Design Space Exploration](https://arxiv.org/abs/2605.13398)
...
### [13] [Reward-Weighted On-Policy Distillation with an Open Property-Equivalence Verifier for NL-to-SVA Generation](https://arxiv.org/abs/2605.13501)
...
### [14] [Efficient Implementation of an Adaptive Transformer Accelerator for Massive MIMO Outdoor Localization](https://arxiv.org/abs/2605.13507)
...
### [15] [Memristor Technologies for Dynamic Vision Sensors: A Critical Assessment and Research Roadmap](https://arxiv.org/abs/2605.13699)
...
### [16] [Divergent Multi-Version Execution (DME): Canonical Instruction-Trace Fault Detection via Structural Address-Space Decorrelation](https://arxiv.org/abs/2605.12576)
...
### [17] [Language-Based Agent Control](https://arxiv.org/abs/2605.12863)
...
### [18] [LFPL: Revisited and Mechanized](https://arxiv.org/abs/2605.12893)
...
### [19] [Liquid Tree Automata](https://arxiv.org/abs/2605.13456)
...
### [20] [On the Complexity of Checking Soundness of Natural Reductions (Extended Version)](https://arxiv.org/abs/2605.13780)
...
### [21] [Thin Trees for Near Minimum Cuts](https://arxiv.org/abs/2605.12669)
...
### [22] [Time and Supply Fairness in Electricity Distribution using $k$-times bin packing](https://arxiv.org/abs/2605.12812)
...
### [23] [The Power of Graph Doubling: Computing Ultrabubbles in a Bidirected Graph by Reducing to Weak Superbubbles](https://arxiv.org/abs/2605.13074)
...
### [24] [Distributed Approximate Maximum Matching and Minimum Vertex Cover via Generalized Graph Decomposition](https://arxiv.org/abs/2605.13264)
*Peter Davies-Peck*
...
### [25] [Tighter relaxations for MAP-MRF optimization via Singleton Arc Consistency](https://arxiv.org/abs/2605.13392)
...
### [26] [Low-Cost Arborescence Under Edge Faults](https://arxiv.org/abs/2605.13800)
...
### [27] [Min-Max Optimization Requires Exponentially Many Queries](https://arxiv.org/abs/2605.13806)
