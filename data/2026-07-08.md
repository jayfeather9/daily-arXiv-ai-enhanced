...
### [1] [On the Communication Complexity of Maximum Matching and Negative-Weight Shortest Paths](https://arxiv.org/abs/2607.05751)
...
### [2] [Data-dependent Evaluations for Budgeted Submodular Maximization](https://arxiv.org/abs/2607.05759)
...
### [3] [Chunky Chains: Graph Drawings on Small Screens](https://arxiv.org/abs/2607.06029)
...
### [4] [Load Balancing under Adaptive Bin Deletions](https://arxiv.org/abs/2607.06211)
...
### [5] [Breadth-First Search in Succinct Planar Graphs](https://arxiv.org/abs/2607.06221)
*Johannes Meintrup*
...
### [6] [A Unique Normal Form for Tensor Trains over Arbitrary Fields](https://arxiv.org/abs/2607.06271)
*Renaud Vilmart*
...
### [7] [Adversarial Robustness for Small Frequency Moments and a Weak Equivalence Theorem for Turnstile Streams](https://arxiv.org/abs/2607.06312)
...
### [8] [Improved subexponential analysis of the Random-Action-Removal algorithm for 2-player turn-based games and non-binary AUSOs](https://arxiv.org/abs/2607.06334)
*Uri Zwick*
...
### [9] [Faster Exponential-Time Approximate Counting via Bounded Self-Reductions](https://arxiv.org/abs/2607.06393)
...
### [10] [Compiling Bioinformatics Recurrences](https://arxiv.org/abs/2607.06225)
...
### [11] [Bounded-Memory Parallel Image Pulling for Large Container Images](https://arxiv.org/abs/2607.05596)
...
### [12] [Layer 2 Coordinated Trusted Setup for Continuous CRS Generation](https://arxiv.org/abs/2607.05776)
...
### [13] [MatrixFSDP: communication-free matrix optimizers under ZeRO-3 parameter sharding](https://arxiv.org/abs/2607.05895)
...
### [14] [The Surplus Parking Gathering Problem in Infinite Grids](https://arxiv.org/abs/2607.05983)
...
### [18] [UBEP: Re-architecting Expert Parallelism Communication Library for Production Superpods](https://arxiv.org/abs/2607.06202)
...
### [19] [BitFair: A 12nm Bit-Serial CNN Accelerator with Learnable Early Termination and Adaptive Bit Ordering for Ultra-Low-Power XR Vision](https://arxiv.org/abs/2607.05445)
*Ang Li,Chang Gao*
...
### [20] [Neuromorphic Silicon Neuron Controller for Adaptive Deep Brain Stimulation in Parkinson's Disease](https://arxiv.org/abs/2607.05453)
...
### [21] [Is Your NPU Ready for LLMs? Dissecting the Hidden Efficiency Bottlenecks in Mobile LLM Inference](https://arxiv.org/abs/2607.05475)
...
### [22] [NEMESIS: NEtlist-Driven Modeling and Equation Synthesis with Inversion-Aware SPICE Anchoring](https://arxiv.org/abs/2607.05657)
...
### [23] [Boosting FPGA Performance with Direct BRAM-DSP Paths](https://arxiv.org/abs/2607.05756)
...
### [24] [GPU-Accelerated Effective Resistance Analysis for 3D IC Power Delivery Network](https://arxiv.org/abs/2607.05818)
